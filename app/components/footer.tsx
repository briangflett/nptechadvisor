  ...
  return (
    ...
    >
      <div className="container ">
        <div className="mb-12 grid grid-cols-3 gap-4  md:px-4">
          <DonateButton />
          <p className="mb-8  text-base leading-relaxed text-body-color dark:text-body-color-dark">
            We are a group of volunteers who help non profits apply the latest
            technology to drive toward their mission.
          </p>
          <div className="items-right flex justify-end ">
            <a
              href="/"
              aria-label="social-link"
              className="mr-4 text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary md:mr-6"
            >
              <svg
                width="9"
                height="18"
